  ...
  sellram = (rowData) => {
    ...
    render() {
        ...
        <ImageBackground source={UImage.transactionA} resizeMode="stretch" style={[{width:ScreenWidth},ScreenUtil.isIphoneX()?{minHeight:ScreenWidth*0.164}:{height:ScreenWidth*0.164}]}>
            <Header {...this.props} onPressLeft={this.props.navigation.state.params ? this.props.navigation.state.params.returnkey : false} title="内存交易"  backgroundColors={UColor.transport} />
        </ImageBackground>
