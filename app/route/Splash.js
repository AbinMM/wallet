    ...
    this.props.dispatch({type:'login/getthemeSwitching',callback:(theme)=>{
      if(true){  
        //白色版
          ...
          UColor.tintfont= "#4CA6FF";
          UColor.titletop= '#2279C5'; //顶部标题背景色 UColor.navigation
          UColor.secdfont= "#F6F5FA";
          UColor.mainfont= "#FFFFFF";
          UColor.tintstart= '#caccd2'; //Loading背景色
          ...
          // UImage.pool_bg= require('../img/day/pool_bg.png'),
          ...
          //新的图片
          // UImage.my_aboutus= require('../img/newimg/my_aboutus.png');
          // UImage.my_activity= require('../img/newimg/my_activity.png');
          // UImage.my_help= require('../img/newimg/my_help.png');
          // UImage.my_share= require('../img/newimg/my_share.png');
          // UImage.my_system= require('../img/newimg/my_system.png');
          // UImage.my_wallet= require('../img/newimg/my_wallet.png');
        ...
        //黑色版
          ...
          UImage.pool_bg= require('../img/pool_bg.png'),
